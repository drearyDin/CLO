...
public void resetBoardIcon() { board.setIcon(boardImage); }
...
private JLabel H11;
private JLabel H12;
private Area MissScarlet;
private Area ProfPlum;
private Area ColMustard;
private Area MrsPeacock;
private Area MrGreen;
private Area MrsWhite;
private JPanel row1;
private JPanel row2;
private JPanel row3;
private JPanel row4;
private JPanel row5;*/
	...
	//Study.setIcon(new ImageIcon("C:/locations1/Study.jpg"));

	Study.setLocation(10, 10);
	Study.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
	Hall = new JLabel ("Hall");
	Hall.setSize(150, 150);
	Lounge = new JLabel ("Lounge");
	Lounge.setSize(150, 150);
	Library = new JLabel ("Library");
	Library.setSize(150, 150);
	BilliardRoom = new JLabel ("Billiard Room");
	BilliardRoom.setSize(150, 150);
	DiningRoom = new JLabel("Dining Room");
	DiningRoom.setSize(150, 150);
	Conservatory = new JLabel("Conservatory");
	Conservatory.setSize(150, 150);
	Ballroom = new JLabel("Ballroom");
	Ballroom.setSize(150, 150);
	Kitchen = new JLabel("Kitchen");
	Kitchen.setSize(150, 150);
	H01 = new JLabel("H01");
	H01.setSize(50, 150);
	H02 = new JLabel("H02");
	H02.setSize(50, 150);
	...
	row1.add(Study); row1.add(H01); row1.add(Hall); row1.add(H02); row1.add(Lounge);
	row2 = new JPanel();
	row2.setLayout(new FlowLayout());
	row2.add(H03); row2.add(H04); row2.add(H05);
	row3 = new JPanel();
	row3.setLayout(new FlowLayout());
	row3.add(Library); row3.add(H06); row3.add(BilliardRoom); row3.add(H07); row3.add(DiningRoom);
	row4 = new JPanel();
	row4.setLayout(new FlowLayout());
	row4.add(H08); row4.add(H09); row4.add(H10);
	row5 = new JPanel();
	row5.setLayout(new FlowLayout());
	row5.add(Conservatory); row5.add(H11); row5.add(Ballroom); row5.add(H12); row5.add(Kitchen);
