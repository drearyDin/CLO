...
public class PlayerView extends JTabbedPane implements ChangeListener {
    ...
    public GameEntityID getWeaponAssumption(){ return weaponAssumptionCard; }
    public GameEntityID getSuspectAssumption(){ return suspectAssumptionCard; }
    public GameEntityID getRoomAssumption(){ return roomAssumptionCard; }
